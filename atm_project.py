...
#while loop checks existance of enterd username//
while True:
    user=input('\nENTER USER NAME:')
    user=user.lower()
    if user in users:
...
#in case of a valid pin-containning , or exiting
if count==3:
    print('-------------------')
    print('***')
    print('3 UNSUCCESSFUL PIN ATTEMPS , EXITING')
